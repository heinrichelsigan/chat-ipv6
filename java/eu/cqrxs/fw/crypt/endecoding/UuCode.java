...
public class UuCode {
    ...
    public byte[] uuDecToBytes(String uuEncString) {
    ...
    public String uuEncBytes(byte[] inBytes) {
    ...
    public String uuDec(String uuEncString) { 
        UUDecoder uud = new UUDecoder();
        /* 
            uud.mode = 664; 
            uud.bufferName = "aString"; 
    ...
    public String uuEnc(String inString) {
    ...
    public static void usage() {
        System.err.println("Usage: java UuCoder [encode|decode] [plainString|uuEncodedString]\n" +
            "e.g.:\n\tjava UuCoder encode \"`fortune -s`\"\n" + 
            "\tjava UuCoder encode HalloWorldThisIsAnApproximateShortSentence\n" +
            "java UuCoder decode [uuEncodedString]\n");
        System.exit(1);
    }


    public static void main(String[] args) {
        UuCode uuCode = new UuCode();
        if (args.length < 2) 
            usage();
