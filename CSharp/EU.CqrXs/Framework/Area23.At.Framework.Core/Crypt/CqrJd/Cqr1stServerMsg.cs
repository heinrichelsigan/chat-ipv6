...
namespace Area23.At.Framework.Core.Crypt.CqrJd
{
    ...
    public class Cqr1stServerMsg : CqrBaseMsg
    {
        ...
        public string Cqr1stSrvMsg(string msg, EncodingType encType = EncodingType.Base64)
        {            
        ...
        /// <summary>
        /// Cqr1stSrvAttachment encrypts a file attchment message
        /// </summary>
        ...
        public string Cqr1stSrvAttachment(string fileName, string mimeType, string base64Mime, out MimeAttachment attachment,
        ...
        public MsgContent NCqr1stSrvMsg(string cqrMessage, EncodingType encType = EncodingType.Base64)
        {
        ...
        /// <returns></returns>
        public string Send1stCqrSrvMsg(string msg, IPAddress srvIp, EncodingType encodingType = EncodingType.Base64)
        {
        ...
        public string Send1stCqrSrvAttachment(string fileName, string mimeType, string base64Mime, IPAddress srvIp, out MimeAttachment mimeAttachment,
            EncodingType encodingType = EncodingType.Base64, int serverPort = 7777, string sMd5 = "", string sSha256 = "")
        {

            string encrypted = String.Format("TextBoxEncrypted={0}\r\nTextBoxDecrypted=\r\nTextBoxLastMsg=\r\nButtonSubmit=Submit",
                base.CqrMsgAttachment(fileName, mimeType, base64Mime, out mimeAttachment, encodingType, sMd5, sSha256));
