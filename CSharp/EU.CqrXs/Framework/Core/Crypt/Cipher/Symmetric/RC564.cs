...
namespace EU.CqrXs.Framework.Core.Crypt.Cipher.Symmetric
{
    ...
    public static class RC564
    {
        ...
        {
            byte[] plainScratched = EU.CqrXs.Framework.Core.Crypt.EnDeCoding.DeEnCoder.GetBytesFromBytes(plainData);
        ...
        public static byte[] Decrypt(byte[] cipherData)
        {
            ...
            byte[] plainShrinken = EU.CqrXs.Framework.Core.Crypt.EnDeCoding.DeEnCoder.GetBytesTrimNulls(plainData);
