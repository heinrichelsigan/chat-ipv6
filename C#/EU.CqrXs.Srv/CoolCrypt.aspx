<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CoolCrypt.aspx.cs" Inherits="EU.CqrXs.Srv.CoolCrypt" validateRequest="false" %>
    ...
    <form id="CoolCryptForm" runat="server" method="post" enableviewstate="True" enctype="multipart/form-data" submitdisabledcontrols="True" style="background-color: transparent;">
        <div style="background-color: transparent; padding-left: 40px; margin-left: 2px;">
            ...
            <div class="odDiv">
                ...
                <span class="rightSpan" style="width: 72px">
                    <asp:Button ID="Button_SetPipeline" runat="server" Text="set pipe" ClientIDMode="Static" 
                        OnClick="Button_SetPipeline_Click" ToolTip="Set symm chpher pipeline" style="max-width: 72px" />
                </span>
            </div>
        </div>
