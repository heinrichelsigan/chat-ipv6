...
namespace Area23.At.Framework.Library.CqrXs.CqrSrv
{
    ...
    public class SrvMsg : BaseMsg
    {
        ...
        /// <summary>
        /// SendSrvMsg sends registration msg to server
        /// </summary>
        /// <param name="msg">string message</param>
        /// <param name="srvIp">public availible server ip address</param>
        /// <param name="encodingType"><see cref="EncodingType"/></param>
        /// <returns></returns>
        public string SendSrvMsg(string msg, IPAddress srvIp, EncodingType encodingType = EncodingType.Base64)
        {
        ...
        /// <summary>
        /// SendSrvAttachment sends an attached base64 encoded file
        /// </summary>
        /// <param name="fileName">file name of attached file</param>
        /// <param name="mimeType"><see cref="Util.MimeType"/></param>
        /// <param name="base64Mime">base64 encoded mime block</param>
        ...
        public string SendSrvAttachment(string fileName, string mimeType, string base64Mime, IPAddress srvIp, out MimeAttachment mimeAttachment,
