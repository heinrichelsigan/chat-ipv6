...
namespace Area23.At.Framework.Library.Cache
{
    ...
    public abstract class MemCacheDict
    {
        ...
        /// </summary>
        protected static ConcurrentDictionary<string, CacheValue> AppDict
        {
            get
            {
        ...
        /// </summary>
        public static string[] AllKeys { get => AppDict.Keys.ToArray(); }
        ...
        public static bool SetValue<T>(string ckey, T tvalue)
        {
        ...
        public static bool RemoveKey(string ckey)
        {
