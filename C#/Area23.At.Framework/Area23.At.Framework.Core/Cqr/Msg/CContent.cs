...
namespace Area23.At.Framework.Core.Cqr.Msg
{
	...
	public class CContent : IMsgAble
	{
        ...
        public virtual string ToJson() => JsonConvert.SerializeObject(this, Newtonsoft.Json.Formatting.Indented);
		...
		public virtual bool IsCFile()
		{
			...
			if (SerializedMsg.IsValidJson())
			{
				if (SerializedMsg.Contains("FileName") && SerializedMsg.Contains("Base64Type"))
					return true;
				return false;
			}
			if (SerializedMsg.IsValidXml() && SerializedMsg.Contains("FileName") && SerializedMsg.Contains("Base64Type"))
				return true;
