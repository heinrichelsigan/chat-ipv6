...
namespace EU.CqrXs.Service.Util
{
    /// <summary>
    /// JsonChatRoom 
    /// </summary>
    public static class JsonChatRoom
    {
        ...
        static JsonChatRoom()
        {
            ...
            {
                Area23Log.Logger.LogOriginMsgEx("JsonChatRooms", "JsonChatRoom()", exCtor);
            }
        ...
        public static bool DeleteChatRoom(string chatRoomNr)
        {
            ...
            lock (_lock)
            {
                if (System.IO.File.Exists(jsonChatRoomFileName)) // we need to create chatroom
                {
                    ...
                    {
                        Area23Log.Logger.LogOriginMsgEx("JsonChatRooms", 
        ...
        public static List<string> ChatRoomNumbersFromFs()
        {
            ...
            {
                Area23Log.Logger.LogOriginMsgEx("JsonChatRooms", "ChatRoomNumbersFromFs()", exChatRoomFs);
            }
        ...
        public static List<string> GetJsonChatRoomsFromCache()
        {
            ...
            {
                Area23Log.Logger.LogOriginMsgEx("JsonChatRooms", "GetJsonChatRoomsFromCache(): Failed to load chatrooms from cache", exLoadFromCache);
            }
