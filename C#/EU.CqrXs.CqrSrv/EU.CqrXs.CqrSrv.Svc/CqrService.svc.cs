...
{
    [SwaggerWcf("/v1/rest")]
    [SwaggerWcfTag("CqrService")]
    [SwaggerWcfServiceInfo(
        title: "EU.CqrXs.CqrSrv.Svc",
        version: "0.0.1",
    ...
    public class CqrService : ICqrService
    {
        #region /books
        ...
        public Book[] ReadAuthorBooks(string id)
        {
            ...
            {
                Book[] books = Store.Books.ToArray();
                return books;
            }
        ...
        public Language[] ReadLanguages()
        {
            ...
            Language[] languages = Language.GetAllLanguages();
            return languages;
        }
