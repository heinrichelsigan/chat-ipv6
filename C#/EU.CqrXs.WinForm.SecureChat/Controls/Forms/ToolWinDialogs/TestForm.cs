...
namespace EU.CqrXs.WinForm.SecureChat.Controls.Forms
{
    public partial class TestForm : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            string? appServerKey = CacheHashDict.CacheDict.GetValue<string>(Constants.APP_SERVER_KEY);
            ...
            else
            {
                ...
                CacheHashDict.CacheDict.SetValue<string>(Constants.APP_SERVER_KEY, myServerKey);                 
            }
