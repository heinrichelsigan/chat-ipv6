...
namespace EU.CqrXs.WinForm.SecureChat.Controls.Forms.Base
{
    ...
    public class BaseChatForm : Form
    {
                ...
                (cbName.ToLower() == "comboboxip" && !IPAddress.TryParse(cbText, out IPAddress? ipAddress)))
            {
                ...
                {                    
                    case "comboboxsecretkey":
                        ...
                        dialog.ShowDialog();
                        string? appInputDialog0 = CacheHashDict.CacheDict.GetValue<string>(Constants.APP_INPUT_DIALOG);
                    ...
                    case "comboboxip":
                        ...
                        dialogIp.ShowDialog();
                        string? appInputDialog1 = CacheHashDict.CacheDict.GetValue<string>(Constants.APP_INPUT_DIALOG);
                    ...
                    case "comboboxcontacts":
                        ...
                        string? appInputDialog2 = CacheHashDict.CacheDict.GetValue<string>(Constants.APP_INPUT_DIALOG);
        ...
        {
            CacheHashDict.CacheDict.SetValue<int>(Constants.APP_TRANSPARENT_BADGE, 0);
            ...
            bool? testApp = CacheHashDict.CacheDict.GetValue<bool>(Constants.CQRXS_TEST_FORM);
